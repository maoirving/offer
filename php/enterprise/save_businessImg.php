...
if ((($_FILES["file"]["type"] == "image/gif")
    ...
    if ($_FILES["file"]["error"] > 0) {
        ...
        $uploadDir = '../../upload/business_images/';
        ...
        if (!is_array($_FILES["file"]["name"])) //single file
        {
            ...
            $business_imgUrl = 'upload/business_images/' . $fileName;
        }
...
if (empty($_COOKIE["company_id"])) {
    $sql = "INSERT INTO company(business_imgUrl)
        VALUES ('$business_imgUrl')";
...
WHERE
    ...
    $sql1 = "UPDATE company SET business_imgUrl = '$business_imgUrl' WHERE company_id = '$company_id'";
