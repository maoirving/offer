...
if ((($_FILES["file"]["type"] == "image/gif")
    ...
    if ($_FILES["file"]["error"] > 0) {
        ...
        if (!is_array($_FILES["file"]["name"])) //single file
        {
            ...
            $recruiter_imgUrl = 'upload/user_images/' . $fileName;
        }
...
////            $recruiter_imgUrl = "user_images/" . $_FILES["file"]["name"];
////        }
    }
} else {
    echo "非法的文件格式";
...
$sql = "UPDATE recruiter SET user_imgUrl = '$recruiter_imgUrl' WHERE username = '$recruiter_username'";
